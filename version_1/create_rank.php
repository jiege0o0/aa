<?php 
	...
	$file1  = $dataFilePath.'day_rank/server'.$serverID.'/rank'.date('Ymd', time()).'_1.txt';//今天的排行榜数据
	do{
		...
		$file2  = $dataFilePath.'day_rank/server'.$serverID.'/rank'.date('Ymd', time()).'_2.txt';
		$file3  = $dataFilePath.'day_rank/server'.$serverID.'/rank'.date('Ymd', time()).'_3.txt';
		$file4  = $dataFilePath.'day_rank/server'.$serverID.'/rank'.date('Ymd', time()).'_4.txt';
		$file5  = $dataFilePath.'day_rank/server'.$serverID.'/rank'.date('Ymd', time()).'_5.txt';
		$file6  = $dataFilePath.'day_rank/server'.$serverID.'/rank'.date('Ymd', time()).'_6.txt';
