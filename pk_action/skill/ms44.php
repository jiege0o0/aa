<?php 
	...
	//技：心灵控制(技)：所有单位禁固一回合
	class sm_44_0 extends SkillBase{
	...
	//每3次攻击，为自己回复10MP
	class sm_44_1 extends SkillBase{
		public $cd = 3;
	...
	class sm_44_2 extends SkillBase{
		public $cd = 1;
		function action($user,$self,$enemy){
	...
	//增加辅助5%攻击
	class sm_44_3 extends SkillBase{
		public $cd = 0;
		function action($user,$self,$enemy){
	...
	class sm_44_f1 extends SkillBase{
		public $cd = 5;
		function action($user,$self,$enemy){
			$len = count($enemy->team->currentMonster);
			for($i=0;$i<$len;$i++)
	...
	class sm_44_f2 extends SkillBase{
		public $cd = 1;
		function action($user,$self,$enemy){
